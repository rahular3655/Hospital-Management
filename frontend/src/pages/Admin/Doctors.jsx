...
export default function Doctors() {
  ...
  const columns = [
    ...
    { field: "specialized_in", headerName: "Specialized in", width: 130 },
    {
      field: "age",
      headerName: "Age",
      headerAlign: "center",
  ...
  console.log(admin?.user_id, "llll");
  ...
  console.log(details, "iuigfriushfiurhih");
  ...
  const uploadData = (e) => {
    ...
    for (let key in details) {
      console.log(key, details[key], "hgfsewawesrdrt");
      formSent.append(key, details[key]);
    }
    for (var[key,value] of formSent.entries()){
      console.log(key,value,"valuesssssssssssss")
    }
    console.log(formSent.item, "form in..............");

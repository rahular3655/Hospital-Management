...
export default function Staff() {
  ...
  if (result.isConfirmed===true) {
    axios.delete(`http://127.0.0.1:8000/staffs/staffdetail/${selectionid}/`,{
    headers:{
  ...
  useEffect(() => {
    axios.get("http://127.0.0.1:8000/staffs/stafflist/",{
        headers: {
            'Content-Type': 'application/json',
            "Authorization": `Bearer ${
                authTokens.access
...
const deletedata = (e,id)=>{
  axios.delete(`http://127.0.0.1:8000/staffs/staffdetail/${id}/`,{
    headers:{
      'Content-Type': 'application/json',
      "Authorization": `Bearer ${
          authTokens.access
...
const {admin} = useContext(DeskAuthContext)
  ...
  axios.patch(`http://127.0.0.1:8000/staffs/staffcreate/${id}/`,formUpdateSent,{
    headers: {
...
toast.success('Something went wrong !', {
  ...
  const uploadData = (e) => {  
    ...
    axios.post('http://127.0.0.1:8000/staffs/staffcreate/',formSent,{
        headers: {
            'Content-Type': 'multipart/form-data',
            "Authorization": `Bearer ${
                authTokens.access
        ...
        console.log(response.data)
      setDetails('')
      toast.success('Staff details is added successfully! ', {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: true,
        closeOnClick: true,
            ...
            <form onSubmit={uploadData}>
              ...
              <div className="grid md:grid-cols-2 md:gap-6">
                ...
                <FormControl variant="standard" sx={{ m: 1, minWidth: 200 }}>
                    ...
                    <MenuItem value="Attenders">Attenders</MenuItem>
